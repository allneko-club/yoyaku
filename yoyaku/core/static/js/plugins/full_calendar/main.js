...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    var NativeFormatter = /** @class */ (function () {
        ...
        NativeFormatter.prototype.formatRange = function (start, end, context, betterDefaultSeparator) {
            ...
            //カレンダーの開始日-終了日とイベントの開始時間〜終了時間の表示制御をしている
            if (insertion) {
                if(partial0.includes(":")){
                    // イベントの終了時間は表示しない 9:00~ のようにする。
                    return insertion.before + partial0 + separator;
                }else{
                    // カレンダーの開始日-終了日は通常通り表示。
    ...
    */
    ...
    var BASE_OPTION_DEFAULTS = {
        eventDisplay: 'auto',
        defaultRangeSeparator: ' 〜 ', //開始時間と終了時間の区切り
        titleRangeSeparator: ' \u2013 ',
